...
class ReturnGoodsPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
            ...
            <div style={styles.container}>
               {/* btn */}
                  <div style={styles.tops}>
                    ...
                    <span style={styles.status}>当前状态： 退货中</span>
                  </div>     
...
export const ReturnGoodsPage1 = connect(mapStateToProps)(ReturnGoodsPage_);
