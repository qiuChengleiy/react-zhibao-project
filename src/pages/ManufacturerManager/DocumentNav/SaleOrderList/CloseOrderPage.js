...
class CloseOrderPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
            ...
            <div style={styles.container}>
               {/* btn */}
                  <div style={styles.tops}>
                    ...
                    <span style={styles.status}>当前状态：交易失败</span>
                  </div>     
...
export const CloseOrderPage1 = connect(mapStateToProps)(CloseOrderPage_);
