...
class PendingDliveryPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
            ...
            <div style={styles.container}>
               {/* btn */}
                  <div style={styles.tops}>
                    ...
                    <span style={styles.status}>当前状态： 待发货</span>
                  </div>     
...
export const PendingDliveryPage1 = connect(mapStateToProps)(PendingDliveryPage_);
