...
class SuccessOrderPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
            ...
            <div style={styles.container}>
               {/* btn */}
                  <div style={styles.tops}>
                    ...
                    <span style={styles.status}>当前状态： 已签收</span>
                  </div>     
...
export const SuccessOrderPage1 = connect(mapStateToProps)(SuccessOrderPage_);
