...
class DismissalPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
        ...
        return (
            ...
            {/* 其他信息 */}
                  <Card title="其他信息">
                    ...
                    <Card.Grid style={gridStyle.g2}>已驳回</Card.Grid>
...
export const DismissalPage1 = connect(mapStateToProps)(DismissalPage_);
