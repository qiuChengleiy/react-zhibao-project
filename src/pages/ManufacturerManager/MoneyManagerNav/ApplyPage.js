...
class ApplysPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
    ...
    render() {
        ...
        const btnArr = ['厂商申请','经销商申请','普通用户申请']
        ...
        return (
            <div style={styles.container}>   
                  ...
                  <Buttons title={btnArr} styles={{bt1:styles.btn,bt2:styles.btn_}}/>
                   ...
                   <Table_  
                      columns={DistributorManager.money_manager.cash_applys} 
                      scrollX={500}
...
export const ApplysPage1 = connect(mapStateToProps)(ApplysPage_);
