...
class CollectUserPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
            ...
            <div style={styles.container}> 
                ...
                />  
                  ...
                  <Buttons title={btnArr} styles={{bt1:styles.btn,bt2:styles.btn_}}/>
                   ...
                   <Table_  
                      columns={DistributorManager.evaluate.collect_user} 
                      scrollX={2000}
...
export const CollectUserPage = connect(mapStateToProps)(CollectUserPage_);
