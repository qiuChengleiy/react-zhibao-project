...
class UserEvaluationPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
        ...
        return (
            <div style={styles.container}> 
                ...
                <Search
                    ...
                    style={{position: 'absolute',width:'40%',left:220}}
                />  
                  ...
                  <Buttons title={btnArr} styles={{bt1:styles.btn,bt2:styles.btn_}}/>
                   ...
                   <Table_  
                      columns={DistributorManager.evaluate.user_evaluate} 
                      scrollX={2000}
...
export  const UserEvaluationPage = connect(mapStateToProps)(UserEvaluationPage_);
