...
class OrdinaryUserPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
        ...
        return (
            <div style={styles.container}>   
                  ...
                  <Buttons title={btnArr} styles={{bt1:styles.btn,bt2:styles.btn_}}/>
                   ...
                   <Table_  
                      columns={DistributorManager.UserManager.OrdinaryUser} 
                      scrollX={2000}
...
export const OrdinaryUserPage = connect(mapStateToProps)(OrdinaryUserPage_);
