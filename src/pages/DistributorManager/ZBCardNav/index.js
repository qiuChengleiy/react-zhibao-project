...
class ZBCardNavsPage_ extends React.Component {
    constructor(...args) {
        super(...args);
        this.state = {
            data:null,
        ...
        return (
            <div style={styles.container}>   
                  ...
                  <Buttons title={btnArr} styles={{bt1:styles.btn,bt2:styles.btn_}}/>
                   ...
                   <Table_  
                      columns={DistributorManager.zb_card.zbcard_print} 
                      scrollX={2000}
...
export const ZBCardNavsPage = connect(mapStateToProps)(ZBCardNavsPage_);
